...
export default function CardWork({ work }) {
  ...
  return (
    <>
      <div
        className="bg-white w-[320px] h-[160px] lg:w-[420px] lg:h-[210px] hover:w-[321px] hover:h-[161px] hover:lg:w-[421px] hover:lg:h-[211px] m-3 flex justify-between items-center rounded-lg drop-shadow-md hover:drop-shadow-xl cursor-pointer"
