...
export default function CardWork({ work }) {
  ...
  return (
    <>
      <div
        className="bg-white w-[320px] h-[160px] lg:w-[380px] lg:h-[190px] hover:bg-gray-200 m-3 flex justify-between items-center rounded-lg drop-shadow-md hover:drop-shadow-xl cursor-pointer"
