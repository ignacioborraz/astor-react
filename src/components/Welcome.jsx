...
export default function Welcome({ title, subt1, subt2, button, to }) {
  return (
    <div className='flex flex-col justify-center items-center text-white w-full h-screen px-5 mx-auto md:mt-5 md:mb-10 md:h-96 md:rounded-lg md:items-start md:flex-grow bg-[url("/img/astor.jpg")] bg-center bg-cover'>
      <h2 className="font-bold text-5xl mb-1 text-center md:text-left xl:text-6xl">
        {title}
      </h2>
      <p className="text-2xl mb-1 text-center">{subt1}</p>
